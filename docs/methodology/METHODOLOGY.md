...
**1.0 Scope Note:** The live API pipeline uses Altman Z-Score as the sole scoring model. The legacy scoring framework in `src/legacy/credit_risk_assessment.py` is not invoked by the FastAPI service.
