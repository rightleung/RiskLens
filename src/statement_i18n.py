# Auto-generated from web/src/translations.ts prettifyKey dictionary
# Maps normalized statement keys to localized labels
...
STATEMENT_I18N = {
    ...
    'net_income_continuous_operations': {
        'en': 'Net Income (Continuing Operations)',
        'zh-CN': '持续经营净利润',
        'zh-TW': '持續經營淨利潤',
        'ja': '継続事業純利益',
    },
    'ebitda': {
        'en': 'EBITDA',
        'zh-CN': '息税折旧摊销前利润 (EBITDA)',
        'zh-TW': '息稅折舊攤銷前利潤 (EBITDA)',
        'ja': 'EBITDA',
    },
    'pretax_income': {
        'en': 'Pretax Income',
    ...
    'net_income_discontinuous_operations': {
        'en': 'Net Income (Discontinued)',
        'zh-CN': '终止经营净利润',
        'zh-TW': '終止經營淨利潤',
        'ja': '非継続事業純利益',
    },
    'net_income_common_stockholders': {
        'en': 'Net Income available to Common',
        'zh-CN': '归属普通股股东净利润',
        'zh-TW': '歸屬普通股股東淨利潤',
        'ja': '普通株主帰属純利益',
    },
    'minority_interests': {
        'en': 'Minority Interests',
        'zh-CN': '少数股东损益',
        'zh-TW': '少數股東損益',
        'ja': '少数株主利益',
    },
    'total_other_income_expense_net': {
        'en': 'Total Other Income/Expense',
        'zh-CN': '其他收支净额',
        'zh-TW': '其他收支淨額',
        'ja': 'その他の収支純額',
    },
    ...
    'normalized_income': {
        'en': 'Normalized Income',
        'zh-CN': '标准化净利润',
        'zh-TW': '標準化淨利潤',
        'ja': '正規化純利益',
    },
    'tax_effect_of_unusual_items': {
        'en': 'Tax Effect of Unusual Items',
        'zh-CN': '非经常性项目的税收影响',
        'zh-TW': '非經常性項目的稅收影響',
        'ja': '特別項目の税効果',
    },
    'tax_rate_for_calcs': {
        'en': 'Tax Rate for Calcs',
        'zh-CN': '计算用税率',
        'zh-TW': '計算用稅率',
        'ja': '計算用税率',
    },
    'net_income_from_continuing_operation_net_minority_interest': {
        'en': 'Net Income (Continuing Ops, excl. Minority)',
        'zh-CN': '持续经营净利润（不含少数股东权益）',
        'zh-TW': '持續經營淨利潤（不含少數股東權益）',
        'ja': '継続事業純利益（少数株主利益控除後）',
    },
    ...
    'total_operating_income_as_reported': {
        'en': 'Operating Income (As Reported)',
        'zh-CN': '报告营业利润',
        'zh-TW': '報告營業利潤',
        'ja': '報告済み営業利益',
    },
    'diluted_average_shares': {
        'en': 'Diluted Average Shares',
        'zh-CN': '稀释后平均股数',
        'zh-TW': '稀釋後平均股數',
        'ja': '希薄化後平均株式数',
    },
    'basic_average_shares': {
        'en': 'Basic Average Shares',
        'zh-CN': '基本平均股数',
        'zh-TW': '基本平均股數',
        'ja': '基本的平均株式数',
    },
    ...
    'diluted_ni_availto_com_stockholders': {
        'en': 'Diluted NI Avail. to Common Stockholders',
        'zh-CN': '归属于普通股东的稀释净利润',
        'zh-TW': '歸屬於普通股東的稀釋淨利潤',
        'ja': '普通株主帰属希薄化純利益',
    },
    'net_income_including_noncontrolling_interests': {
        'en': 'Net Income (incl. Non-controlling)',
        'zh-CN': '净利润（含少数股东损益）',
        'zh-TW': '淨利潤（含少數股東損益）',
        'ja': '純利益（非支配持分含む）',
    },
    'net_income_from_continuing_and_discontinued_operation': {
        'en': 'Net Income (Continuing & Discontinued)',
        'zh-CN': '持续与终止经营净利润',
        'zh-TW': '持續與終止經營淨利潤',
        'ja': '継続・廃止事業純利益',
    },
    ...
    'other_income_expense': {
        'en': 'Other Income/Expense',
        'zh-CN': '其他收入/支出',
        'zh-TW': '其他收入/支出',
        'ja': 'その他の収益/費用',
    },
    'other_non_operating_income_expenses': {
        'en': 'Other Non-operating Income/Expenses',
        'zh-CN': '其他营业外收支',
        'zh-TW': '其他營業外收支',
        'ja': 'その他の営業外収益/費用',
    },
    ...
    'interest_income_non_operating': {
        'en': 'Interest Income (Non-operating)',
        'zh-CN': '营业外利息收入',
        'zh-TW': '營業外利息收入',
        'ja': '営業外受取利息',
    },
    ...
    'interest_expense_non_operating': {
        'en': 'Interest Expense (Non-operating)',
        'zh-CN': '营业外利息费用',
        'zh-TW': '營業外利息費用',
        'ja': '営業外支払利息',
    },
    ...
    'net_non_operating_interest_income_expense': {
        'en': 'Net Non-operating Interest Income/Expense',
        'zh-CN': '营业外净利息收支',
        'zh-TW': '營業外淨利息收支',
        'ja': '営業外純利息収支',
    },
    ...
    'special_income_charges': {
        'en': 'Special Income/Charges',
        'zh-CN': '特殊收益/费用',
        'zh-TW': '特殊收益/費用',
        'ja': '特別利益/損失',
    },
    'restructuring_and_mergern_acquisition': {
        'en': 'Restructuring & M&A',
        'zh-CN': '重组及并购费用',
        'zh-TW': '重組及併購費用',
        'ja': 'リストラ・M&A費用',
    },
    ...
    'cash_cash_equivalents_and_short_term_investments': {
        'en': 'Cash, Equivalents & Short Term Investments',
        'zh-CN': '现金、等价物及短期投资',
        'zh-TW': '現金、等價物及短期投資',
        'ja': '現金同等物及び短期投資',
    },
    'other_short_term_investments': {
        'en': 'Other Short Term Investments',
        'zh-CN': '其他短期投资',
        'zh-TW': '其他短期投資',
        'ja': 'その他の短期投資',
    },
    ...
    'investments_and_advances': {
        'en': 'Investments & Advances',
        'zh-CN': '投资及垫款',
        'zh-TW': '投資及墊款',
        'ja': '投資及び貸付金',
    },
    'long_term_equity_investment': {
        'en': 'Long Term Equity Investment',
        'zh-CN': '长期股权投资',
        'zh-TW': '長期股權投資',
        'ja': '長期株式投資',
    },
    ...
    'long_term_debt_and_capital_lease_obligation': {
        'en': 'Long Term Debt & Capital Lease',
        'zh-CN': '长期债务及资本租赁',
        'zh-TW': '長期債務及資本租賃',
        'ja': '長期借入金及びリース債務',
    },
    'long_term_capital_lease_obligation': {
        'en': 'Long Term Capital Lease',
        'zh-CN': '长期资本租赁',
        'zh-TW': '長期資本租賃',
        'ja': '長期リース債務',
    },
    ...
    'other_equity_adjustments': {
        'en': 'Other Equity Adjustments',
        'zh-CN': '其他权益调整',
        'zh-TW': '其他權益調整',
        'ja': 'その他の資本調整',
    },
    'gains_losses_not_affecting_retained_earnings': {
        'en': 'Gains/Losses Not Affecting Retained Earnings',
        'zh-CN': '不影响留存收益的利得/损失',
        'zh-TW': '不影響保留盈餘的利得/損失',
        'ja': '利益剰余金に影響しない損益',
    },
    ...
    'change_in_receivables': {
        'en': 'Change in Receivables',
        'zh-CN': '应收账款变动',
        'zh-TW': '應收帳款變動',
        'ja': '売掛金の変動',
    },
    'change_in_inventory': {
        'en': 'Change in Inventory',
        'zh-CN': '存货变动',
        'zh-TW': '存貨變動',
        'ja': '棚卸資産の変動',
    },
    'change_in_payable': {
        'en': 'Change in Payables',
        'zh-CN': '应付账款变动',
        'zh-TW': '應付帳款變動',
        'ja': '買掛金の変動',
    },
    'change_in_payables_and_accrued_expense': {
        'en': 'Change in Payables & Accrued Expense',
        'zh-CN': '应付及应计费用变动',
        'zh-TW': '應付及應計費用變動',
        'ja': '買掛金・未払費用の変動',
    },
    'change_in_other_current_assets': {
        'en': 'Change in Other Current Assets',
        'zh-CN': '其他流动资产变动',
        'zh-TW': '其他流動資產變動',
        'ja': 'その他流動資産の変動',
    },
    'change_in_other_current_liabilities': {
        'en': 'Change in Other Current Liabilities',
        'zh-CN': '其他流动负债变动',
        'zh-TW': '其他流動負債變動',
        'ja': 'その他流動負債の変動',
    },
    ...
    'purchase_of_investment': {
        'en': 'Purchase of Investment',
        'zh-CN': '投资购买',
        'zh-TW': '投資購買',
        'ja': '投資の取得',
    },
    'sale_of_investment': {
        'en': 'Sale of Investment',
        'zh-CN': '投资出售',
        'zh-TW': '投資出售',
        'ja': '投資の売却',
    },
    'purchase_of_business': {
        'en': 'Purchase of Business',
        'zh-CN': '企业并购',
        'zh-TW': '企業併購',
        'ja': '事業の取得',
    },
    'net_ppe_purchase_and_sale': {
        'en': 'Net PP&E Purchase & Sale',
        'zh-CN': '固定资产净购销',
        'zh-TW': '固定資產淨購銷',
        'ja': '有形固定資産の取得・売却（純額）',
    },
    ...
    'net_investment_purchase_and_sale': {
        'en': 'Net Investment Purchase & Sale',
        'zh-CN': '净投资购销',
        'zh-TW': '淨投資購銷',
        'ja': '投資の取得・売却（純額）',
    },
    'net_issuance_payments_of_debt': {
        'en': 'Net Issuance/Payments of Debt',
        'zh-CN': '债务发行/偿还净额',
        'zh-TW': '債務發行/償還淨額',
        'ja': '有利子負債の発行・返済（純額）',
    },
    ...
    'common_stock_issuance': {
        'en': 'Common Stock Issuance',
        'zh-CN': '普通股发行',
        'zh-TW': '普通股發行',
        'ja': '普通株式の発行',
    },
    'common_stock_payments': {
        'en': 'Common Stock Payments',
        'zh-CN': '普通股回购',
        'zh-TW': '普通股回購',
        'ja': '自己株式の取得',
    },
    'net_common_stock_issuance': {
        'en': 'Net Common Stock Issuance',
        'zh-CN': '普通股净发行',
        'zh-TW': '普通股淨發行',
        'ja': '普通株式の発行（純額）',
    },
    'common_stock_dividend_paid': {
        'en': 'Common Stock Dividend Paid',
        'zh-CN': '普通股股利支付',
        'zh-TW': '普通股股利支付',
        'ja': '普通株式配当金の支払',
    },
    ...
    'repurchase_of_capital_stock': {
        'en': 'Repurchase of Capital Stock',
        'zh-CN': '股票回购',
        'zh-TW': '股票回購',
        'ja': '自己株式の取得',
    },
    'end_cash_position': {
        'en': 'End Cash Position',
        'zh-CN': '期末现金余额',
        'zh-TW': '期末現金餘額',
        'ja': '期末現金残高',
    },
    'beginning_cash_position': {
        'en': 'Beginning Cash Position',
        'zh-CN': '期初现金余额',
        'zh-TW': '期初現金餘額',
        'ja': '期首現金残高',
    },
    ...
    'effect_of_exchange_rate_changes': {
        'en': 'Effect of Exchange Rate Changes',
        'zh-CN': '汇率变动影响',
        'zh-TW': '匯率變動影響',
        'ja': '為替変動の影響',
    },
    'available_for_sale_securities': {
        'en': 'Available for Sale Securities',
        'zh-CN': '可供出售金融资产',
        'zh-TW': '可供出售金融資產',
        'ja': '売却可能有価証券',
    },
    'capital_lease_obligations': {
        'en': 'Capital Lease Obligations',
        'zh-CN': '融资租赁负债',
        'zh-TW': '融資租賃負債',
        'ja': 'ファイナンスリース債務',
    },
    ...
    'current_accrued_expenses': {
        'en': 'Current Accrued Expenses',
        'zh-CN': '应计费用',
        'zh-TW': '應計費用',
        'ja': '未払費用',
    },
    'current_capital_lease_obligation': {
        'en': 'Current Capital Lease Obligation',
        'zh-CN': '一年内到期融资租赁负债',
        'zh-TW': '一年內到期融資租賃負債',
        'ja': '短期リース債務',
    },
    'current_deferred_liabilities': {
        'en': 'Current Deferred Liabilities',
        'zh-CN': '流动递延负债',
        'zh-TW': '流動遞延負債',
        'ja': '流動繰延負債',
    },
    'current_deferred_revenue': {
        'en': 'Current Deferred Revenue',
        'zh-CN': '流动递延收入',
        'zh-TW': '流動遞延收入',
        'ja': '流動繰延収益',
    },
    ...
    'investmentin_financial_assets': {
        'en': 'Investment in Financial Assets',
        'zh-CN': '金融资产投资',
        'zh-TW': '金融資產投資',
        'ja': '金融資産投資',
    },
    ...
    'machinery_furniture_equipment': {
        'en': 'Machinery, Furniture & Equipment',
        'zh-CN': '机器设备及家具',
        'zh-TW': '機器設備及傢具',
        'ja': '機械装置・器具備品',
    },
    'non_current_deferred_assets': {
        'en': 'Non-current Deferred Assets',
        'zh-CN': '非流动递延资产',
        'zh-TW': '非流動遞延資產',
        'ja': '固定繰延資産',
    },
    'non_current_deferred_taxes_assets': {
        'en': 'Non-current Deferred Tax Assets',
        'zh-CN': '非流动递延所得税资产',
        'zh-TW': '非流動遞延所得稅資產',
        'ja': '固定繰延税金資産',
    },
    'other_current_borrowings': {
        'en': 'Other Current Borrowings',
        'zh-CN': '其他短期借款',
        'zh-TW': '其他短期借款',
        'ja': 'その他の短期借入金',
    },
    ...
    'tradeand_other_payables_non_current': {
        'en': 'Trade & Other Payables (Non-current)',
        'zh-CN': '长期应付款及其他',
        'zh-TW': '長期應付款及其他',
        'ja': '長期買掛金・その他',
    },
    ...
    'cash_flow_from_continuing_financing_activities': {
        'en': 'CF from Continuing Financing Activities',
        'zh-CN': '持续经营筹资活动现金流',
        'zh-TW': '持續經營籌資活動現金流',
        'ja': '継続事業の財務活動によるCF',
    },
    'cash_flow_from_continuing_investing_activities': {
        'en': 'CF from Continuing Investing Activities',
        'zh-CN': '持续经营投资活动现金流',
        'zh-TW': '持續經營投資活動現金流',
        'ja': '継続事業の投資活動によるCF',
    },
    'cash_flow_from_continuing_operating_activities': {
        'en': 'CF from Continuing Operating Activities',
        'zh-CN': '持续经营活动现金流',
        'zh-TW': '持續經營活動現金流',
        'ja': '継続事業の営業活動によるCF',
    },
    'change_in_account_payable': {
        'en': 'Change in Account Payable',
        'zh-CN': '应付账款变动',
        'zh-TW': '應付帳款變動',
        'ja': '買掛金の変動',
    },
    'change_in_other_working_capital': {
        'en': 'Change in Other Working Capital',
        'zh-CN': '其他营运资本变动',
        'zh-TW': '其他營運資本變動',
        'ja': 'その他運転資本の変動',
    },
    'changes_in_account_receivables': {
        'en': 'Changes in Account Receivables',
        'zh-CN': '应收账款变动',
        'zh-TW': '應收帳款變動',
        'ja': '売掛金の変動',
    },
    'income_tax_paid_supplemental_data': {
        'en': 'Income Tax Paid (Supplemental)',
        'zh-CN': '已付所得税（补充数据）',
        'zh-TW': '已付所得稅（補充數據）',
        'ja': '法人税等支払額（補足）',
    },
    'interest_paid_supplemental_data': {
        'en': 'Interest Paid (Supplemental)',
        'zh-CN': '已付利息（补充数据）',
        'zh-TW': '已付利息（補充數據）',
        'ja': '支払利息（補足）',
    },
    'issuance_of_capital_stock': {
        'en': 'Issuance of Capital Stock',
        'zh-CN': '股本发行',
        'zh-TW': '股本發行',
        'ja': '株式の発行',
    },
    'net_business_purchase_and_sale': {
        'en': 'Net Business Purchase & Sale',
        'zh-CN': '企业并购净额',
        'zh-TW': '企業併購淨額',
        'ja': '事業の取得・売却（純額）',
    },
    'net_income_from_continuing_operations': {
        'en': 'Net Income from Continuing Operations',
        'zh-CN': '持续经营净利润',
        'zh-TW': '持續經營淨利潤',
        'ja': '継続事業からの純利益',
    },
    'net_long_term_debt_issuance': {
        'en': 'Net Long Term Debt Issuance',
        'zh-CN': '长期债务净发行',
        'zh-TW': '長期債務淨發行',
        'ja': '長期借入金の純発行',
    },
    'net_short_term_debt_issuance': {
        'en': 'Net Short Term Debt Issuance',
        'zh-CN': '短期债务净发行',
        'zh-TW': '短期債務淨發行',
        'ja': '短期借入金の純発行',
    },
    'net_other_financing_charges': {
        'en': 'Net Other Financing Charges',
        'zh-CN': '其他筹资费用净额',
        'zh-TW': '其他籌資費用淨額',
        'ja': 'その他の財務活動（純額）',
    },
    'net_other_investing_changes': {
        'en': 'Net Other Investing Changes',
        'zh-CN': '其他投资变动净额',
        'zh-TW': '其他投資變動淨額',
        'ja': 'その他の投資活動（純額）',
    },
    ...
    'asset_impairment_loss': {
        'en': 'Asset Impairment Loss',
        'zh-CN': '资产减值损失',
        'zh-TW': '資產減值損失',
        'ja': '資産減損損失',
    },
    'credit_impairment_loss': {
        'en': 'Credit Impairment Loss',
        'zh-CN': '信用减值损失',
        'zh-TW': '信用減值損失',
        'ja': '信用減損損失',
    },
    ...
    'fair_value_change': {
        'en': 'Fair Value Change',
        'zh-CN': '公允价值变动收益',
        'zh-TW': '公允價值變動收益',
        'ja': '公正価値変動損益',
    },
    'total_operating_cost': {
        'en': 'Total Operating Cost',
        'zh-CN': '营业总成本',
        'zh-TW': '營業總成本',
        'ja': '営業総費用',
    },
    ...
    'accrued_interest_receivable': {
        'en': 'Accrued Interest Receivable',
        'zh-CN': '应收利息',
        'zh-TW': '應收利息',
        'ja': '未収利息',
    },
    'allowance_for_doubtful_accounts_receivable': {
        'en': 'Allowance For Doubtful Accounts Receivable',
        'zh-CN': '坏账准备',
        'zh-TW': '壞帳準備',
        'ja': '貸倒引当金',
    },
    'amortization_cash_flow': {
        'en': 'Amortization Cash Flow',
        'zh-CN': '摊销（现金流）',
        'zh-TW': '攤銷（現金流）',
        'ja': '償却費（キャッシュフロー）',
    },
    ...
    'amortization_of_intangibles_income_statement': {
        'en': 'Amortization Of Intangibles Income Statement',
        'zh-CN': '无形资产摊销（利润表）',
        'zh-TW': '無形資產攤銷（利潤表）',
        'ja': '無形資産償却（損益計算書）',
    },
    'asset_impairment_charge': {
        'en': 'Asset Impairment Charge',
        'zh-CN': '资产减值费用',
        'zh-TW': '資產減值費用',
        'ja': '資産減損損失',
    },
    'assets_held_for_sale_current': {
        'en': 'Assets Held For Sale Current',
        'zh-CN': '持有待售流动资产',
        'zh-TW': '持有待售流動資產',
        'ja': '売却目的保有流動資産',
    },
    'average_dilution_earnings': {
        'en': 'Average Dilution Earnings',
        'zh-CN': '平均摊薄收益',
        'zh-TW': '平均攤薄收益',
        'ja': '平均希薄化後利益',
    },
    'buildings_and_improvements': {
        'en': 'Buildings And Improvements',
        'zh-CN': '房屋及建筑物',
        'zh-TW': '房屋及建築物',
        'ja': '建物および構築物',
    },
    'capital_expenditure_reported': {
        'en': 'Capital Expenditure Reported',
        'zh-CN': '报告资本支出',
        'zh-TW': '報告資本支出',
        'ja': '報告資本的支出',
    },
    ...
    'cash_flowsfromusedin_operating_activities_direct': {
        'en': 'Operating Cash Flows Direct',
        'zh-CN': '经营活动现金流（直接法）',
        'zh-TW': '經營活動現金流（直接法）',
        'ja': '営業活動によるキャッシュフロー（直接法）',
    },
    'cash_from_discontinued_financing_activities': {
        'en': 'Cash From Discontinued Financing',
        'zh-CN': '终止经营筹资活动现金流',
        'zh-TW': '終止經營籌資活動現金流',
        'ja': '廃止事業財務活動キャッシュフロー',
    },
    'cash_from_discontinued_investing_activities': {
        'en': 'Cash From Discontinued Investing',
        'zh-CN': '终止经营投资活动现金流',
        'zh-TW': '終止經營投資活動現金流',
        'ja': '廃止事業投資活動キャッシュフロー',
    },
    'cash_from_discontinued_operating_activities': {
        'en': 'Cash From Discontinued Operating',
        'zh-CN': '终止经营经营活动现金流',
        'zh-TW': '終止經營經營活動現金流',
        'ja': '廃止事業営業活動キャッシュフロー',
    },
    'change_in_accrued_expense': {
        'en': 'Change In Accrued Expense',
        'zh-CN': '应计费用变动',
        'zh-TW': '應計費用變動',
        'ja': '未払費用増減額',
    },
    'change_in_income_tax_payable': {
        'en': 'Change In Income Tax Payable',
        'zh-CN': '应交所得税变动',
        'zh-TW': '應交所得稅變動',
        'ja': '未払法人税等増減額',
    },
    'change_in_prepaid_assets': {
        'en': 'Change In Prepaid Assets',
        'zh-CN': '预付资产变动',
        'zh-TW': '預付資產變動',
        'ja': '前払費用増減額',
    },
    'change_in_tax_payable': {
        'en': 'Change In Tax Payable',
        'zh-CN': '应交税费变动',
        'zh-TW': '應交稅費變動',
        'ja': '未払税金増減額',
    },
    'classesof_cash_payments': {
        'en': 'Classes of Cash Payments',
        'zh-CN': '各项现金支付',
        'zh-TW': '各項現金支付',
        'ja': '支払現金内訳',
    },
    'classesof_cash_receiptsfrom_operating_activities': {
        'en': 'Classes of Cash Receipts from Operating',
        'zh-CN': '经营活动各项现金收入',
        'zh-TW': '經營活動各項現金收入',
        'ja': '営業活動収入現金内訳',
    },
    ...
    'current_deferred_assets': {
        'en': 'Current Deferred Assets',
        'zh-CN': '流动递延资产',
        'zh-TW': '流動遞延資產',
        'ja': '流動繰延資産',
    },
    'current_notes_payable': {
        'en': 'Current Notes Payable',
        'zh-CN': '短期应付票据',
        'zh-TW': '短期應付票據',
        'ja': '短期支払手形',
    },
    ...
    'depreciation_income_statement': {
        'en': 'Depreciation Income Statement',
        'zh-CN': '折旧（利润表）',
        'zh-TW': '折舊（利潤表）',
        'ja': '減価償却費（損益計算書）',
    },
    'derivative_product_liabilities': {
        'en': 'Derivative Product Liabilities',
        'zh-CN': '衍生品负债',
        'zh-TW': '衍生品負債',
        'ja': '派生商品負債',
    },
    'dividend_paid_cfo': {
        'en': 'Dividend Paid CFO',
        'zh-CN': '支付的股利（经营）',
        'zh-TW': '支付的股利（經營）',
        'ja': '支払配当金（営業）',
    },
    'dividend_received_cfo': {
        'en': 'Dividend Received CFO',
        'zh-CN': '收到的股利（经营）',
        'zh-TW': '收到的股利（經營）',
        'ja': '受取配当金（営業）',
    },
    ...
    'dividends_received_cfi': {
        'en': 'Dividends Received CFI',
        'zh-CN': '收到的股利（投资）',
        'zh-TW': '收到的股利（投資）',
        'ja': '受取配当金（投資）',
    },
    'duefrom_related_parties_current': {
        'en': 'Due From Related Parties Current',
        'zh-CN': '应收关联方款项（流动）',
        'zh-TW': '應收關聯方款項（流動）',
        'ja': '流動関係会社預け金',
    },
    'duefrom_related_parties_non_current': {
        'en': 'Due From Related Parties Non Current',
        'zh-CN': '应收关联方款项（非流动）',
        'zh-TW': '應收關聯方款項（非流動）',
        'ja': '固定関係会社預け金',
    },
    'dueto_related_parties_current': {
        'en': 'Due To Related Parties Current',
        'zh-CN': '应付关联方款项（流动）',
        'zh-TW': '應付關聯方款項（流動）',
        'ja': '流動関係会社借入金',
    },
    'dueto_related_parties_non_current': {
        'en': 'Due To Related Parties Non Current',
        'zh-CN': '应付关联方款项（非流动）',
        'zh-TW': '應付關聯方款項（非流動）',
        'ja': '固定関係会社借入金',
    },
    'earnings_from_equity_interest': {
        'en': 'Earnings From Equity Interest',
        'zh-CN': '权益投资收益',
        'zh-TW': '權益投資收益',
        'ja': '持分法による投資損益',
    },
    'earnings_from_equity_interest_net_of_tax': {
        'en': 'Earnings From Equity Net Of Tax',
        'zh-CN': '权益投资收益（税后）',
        'zh-TW': '權益投資收益（稅後）',
        'ja': '持分法投資損益（税引後）',
    },
    'earnings_losses_from_equity_investments': {
        'en': 'Earnings Losses From Equity Inv',
        'zh-CN': '权益投资盈亏',
        'zh-TW': '權益投資盈虧',
        'ja': '持分法投資に関する損益',
    },
    ...
    'financial_assets_designatedas_fair_value_through_profitor_loss_total': {
        'en': 'Financial Assets FVTPL Total',
        'zh-CN': '以公允价值计量且其变动计入当期损益的金融资产',
        'zh-TW': '以公允價值計量且其變動計入當期損益的金融資產',
        'ja': 'FVTPL指定金融資産合計',
    },
    'finished_goods': {
        'en': 'Finished Goods',
    ...
    'fixed_assets_revaluation_reserve': {
        'en': 'Fixed Assets Revaluation Reserve',
        'zh-CN': '固定资产重估储备',
        'zh-TW': '固定資產重估儲備',
        'ja': '固定資産再評価積立金',
    },
    'foreign_currency_translation_adjustments': {
        'en': 'Foreign Currency Translation Adj.',
        'zh-CN': '外币报表折算差额',
        'zh-TW': '外幣報表折算差額',
        'ja': '為替換算調整勘定',
    },
    'gain_loss_on_investment_securities': {
        'en': 'Gain Loss On Investment Sec.',
        'zh-CN': '投资证券投资损益',
        'zh-TW': '投資證券投資損益',
        'ja': '投資有価証券売却損益',
    },
    'gain_loss_on_sale_of_business': {
        'en': 'Gain Loss On Sale Of Business',
        'zh-CN': '出售业务的损益',
        'zh-TW': '出售業務的損益',
        'ja': '事業売却損益',
    },
    'gain_loss_on_sale_of_ppe': {
        'en': 'Gain Loss On Sale Of PPE',
        'zh-CN': '处置固定资产损益',
        'zh-TW': '處置固定資產損益',
        'ja': '有形固定資産売却損益',
    },
    'gain_on_sale_of_business': {
        'en': 'Gain On Sale Of Business',
        'zh-CN': '出售业务收益',
        'zh-TW': '出售業務收益',
        'ja': '事業売却益',
    },
    'gain_on_sale_of_ppe': {
        'en': 'Gain On Sale Of PPE',
        'zh-CN': '出售固定资产收益',
        'zh-TW': '出售固定資產收益',
        'ja': '有形固定資産売却益',
    },
    'gain_on_sale_of_security': {
        'en': 'Gain On Sale Of Security',
        'zh-CN': '出售证券收益',
        'zh-TW': '出售證券收益',
        'ja': '有価証券売却益',
    },
    'general_and_administrative_expense': {
        'en': 'General And Administrative Exp',
        'zh-CN': '管理费用',
        'zh-TW': '管理費用',
        'ja': '一般管理費',
    },
    'gross_accounts_receivable': {
        'en': 'Gross Accounts Receivable',
        'zh-CN': '应收账款原值',
        'zh-TW': '應收帳款原值',
        'ja': '売掛金総額',
    },
    'hedging_assets_current': {
        'en': 'Hedging Assets Current',
        'zh-CN': '套期保值资产（流动）',
        'zh-TW': '套期保值資產（流動）',
        'ja': '流動ヘッジ資産',
    },
    'held_to_maturity_securities': {
        'en': 'Held To Maturity Securities',
        'zh-CN': '持有至到期投资',
        'zh-TW': '持有至到期投資',
        'ja': '満期保有目的債券',
    },
    'impairment_of_capital_assets': {
        'en': 'Impairment Of Capital Assets',
        'zh-CN': '资本资产减值',
        'zh-TW': '資本資產減值',
        'ja': '資本資産減損',
    },
    'insurance_and_claims': {
        'en': 'Insurance And Claims',
        'zh-CN': '保险与理赔',
        'zh-TW': '保險與理賠',
        'ja': '保険および請求',
    },
    'interest_paid_cff': {
        'en': 'Interest Paid CFF',
        'zh-CN': '支付的利息（筹资）',
        'zh-TW': '支付的利息（籌資）',
        'ja': '財務活動の支払利息',
    },
    'interest_paid_cfo': {
        'en': 'Interest Paid CFO',
        'zh-CN': '支付的利息（经营）',
        'zh-TW': '支付的利息（經營）',
        'ja': '営業活動の支払利息',
    },
    'interest_paid_direct': {
        'en': 'Interest Paid Direct',
        'zh-CN': '支付的利息（直接法）',
        'zh-TW': '支付的利息（直接法）',
        'ja': '支払利息（直接法）',
    },
    ...
    'interest_received_cfi': {
        'en': 'Interest Received CFI',
        'zh-CN': '收到的利息（投资）',
        'zh-TW': '收到的利息（投資）',
        'ja': '投資活動の受取利息',
    },
    'interest_received_cfo': {
        'en': 'Interest Received CFO',
        'zh-CN': '收到的利息（经营）',
        'zh-TW': '收到的利息（經營）',
        'ja': '営業活動の受取利息',
    },
    'interest_received_direct': {
        'en': 'Interest Received Direct',
        'zh-CN': '收到的利息（直接法）',
        'zh-TW': '收到的利息（直接法）',
        'ja': '受取利息（直接法）',
    },
    'inventories_adjustments_allowances': {
        'en': 'Inventories Adjustments',
        'zh-CN': '存货跌价准备',
        'zh-TW': '存貨跌價準備',
        'ja': '棚卸資産評価引当金',
    },
    ...
    'investmentsin_associatesat_cost': {
        'en': 'Investments in Associates at Cost',
        'zh-CN': '联营企业投资（成本法）',
        'zh-TW': '聯營企業投資（成本法）',
        'ja': '関連会社への投資（原価）',
    },
    'investmentsin_joint_venturesat_cost': {
        'en': 'Investments in Joint Ventures at Cost',
        'zh-CN': '合营企业投资（成本法）',
        'zh-TW': '合營企業投資（成本法）',
        'ja': '共同支配企業への投資（原価）',
    },
    'liabilities_heldfor_sale_non_current': {
        'en': 'Liabilities Held For Sale Non Current',
        'zh-CN': '持有待售非流动负债',
        'zh-TW': '持有待售非流動負債',
        'ja': '売却目的保有固定負債',
    },
    ...
    'minimum_pension_liabilities': {
        'en': 'Minimum Pension Liabilities',
        'zh-CN': '最低养老金负债',
        'zh-TW': '最低養老金負債',
        'ja': '最低年金負債',
    },
    ...
    'net_intangibles_purchase_and_sale': {
        'en': 'Net Intangibles Purchase And Sale',
        'zh-CN': '净买卖无形资产',
        'zh-TW': '淨買賣無形資產',
        'ja': '無形資産純売買額',
    },
    'net_investment_properties_purchase_and_sale': {
        'en': 'Net Investment Prop Purchase/Sale',
        'zh-CN': '净买卖投资性房地产',
        'zh-TW': '淨買賣投資性房地產',
        'ja': '投資不動産純売買額',
    },
    'net_policyholder_benefits_and_claims': {
        'en': 'Net Policyholder Benefits Claims',
        'zh-CN': '净保单持有人利益与赔款',
        'zh-TW': '淨保單持有人利益與賠款',
        'ja': '純保険契約者給付金及び請求',
    },
    'net_preferred_stock_issuance': {
        'en': 'Net Preferred Stock Issuance',
        'zh-CN': '优先股净发行',
        'zh-TW': '優先股淨發行',
        'ja': '優先株純発行額',
    },
    'non_current_accounts_receivable': {
        'en': 'Non Current Accounts Receivable',
        'zh-CN': '非流动应收账款',
        'zh-TW': '非流動應收帳款',
        'ja': '固定売掛金',
    },
    'non_current_accrued_expenses': {
        'en': 'Non Current Accrued Expenses',
        'zh-CN': '非流动应计费用',
        'zh-TW': '非流動應計費用',
        'ja': '固定未払費用',
    },
    'non_current_deferred_liabilities': {
        'en': 'Non Current Deferred Liabilities',
        'zh-CN': '非流动递延负债',
        'zh-TW': '非流動遞延負債',
        'ja': '固定繰延負債',
    },
    'non_current_deferred_revenue': {
        'en': 'Non Current Deferred Revenue',
        'zh-CN': '非流动递延收入',
        'zh-TW': '非流動遞延收入',
        'ja': '固定繰延収益',
    },
    'non_current_deferred_taxes_liabilities': {
        'en': 'Non Current Deferred Taxes Liab.',
        'zh-CN': '非流动递延所得税负债',
        'zh-TW': '非流動遞延所得稅負債',
        'ja': '固定繰延税金負債',
    },
    'non_current_pension_and_other_postretirement_benefit_plans': {
        'en': 'Non Current Pension Benefit Plans',
        'zh-CN': '非流动养老金及离职后福利',
        'zh-TW': '非流動養老金及離職後福利',
        'ja': '固定年金及び退職後給付制度',
    },
    'non_current_prepaid_assets': {
        'en': 'Non Current Prepaid Assets',
        'zh-CN': '非流动预付资产',
        'zh-TW': '非流動預付資產',
        'ja': '固定前払資産',
    },
    'occupancy_and_equipment': {
        'en': 'Occupancy And Equipment',
        'zh-CN': '办公设备及租金',
        'zh-TW': '辦公設備及租金',
        'ja': '施設および設備費',
    },
    'operating_gains_losses': {
        'en': 'Operating Gains Losses',
        'zh-CN': '经营损益',
        'zh-TW': '經營損益',
        'ja': '営業損益',
    },
    'other_cash_adjustment_inside_changein_cash': {
        'en': 'Other Cash Adj Inside Change in Cash',
        'zh-CN': '其他现金变动内部调整',
        'zh-TW': '其他現金變動內部調整',
        'ja': 'その他のキャッシュ内部調整',
    },
    'other_cash_adjustment_outside_changein_cash': {
        'en': 'Other Cash Adj Outside Change in Cash',
        'zh-CN': '其他现金变动外部调整',
        'zh-TW': '其他現金變動外部調整',
        'ja': 'その他のキャッシュ外部調整',
    },
    'other_cash_paymentsfrom_operating_activities': {
        'en': 'Other Cash Payments from Operating',
        'zh-CN': '其他经营现金支付',
        'zh-TW': '其他經營現金支付',
        'ja': 'その他の営業現金支出',
    },
    'other_cash_receiptsfrom_operating_activities': {
        'en': 'Other Cash Receipts from Operating',
        'zh-CN': '其他经营现金收入',
        'zh-TW': '其他經營現金收入',
        'ja': 'その他の営業現金収入',
    },
    'other_equity_interest': {
        'en': 'Other Equity Interest',
        'zh-CN': '其他权益影响',
        'zh-TW': '其他權益影響',
        'ja': 'その他の持分',
    },
    ...
    'other_inventories': {
        'en': 'Other Inventories',
        'zh-CN': '其他存货',
        'zh-TW': '其他存貨',
        'ja': 'その他の棚卸資産',
    },
    'other_non_interest_expense': {
        'en': 'Other Non Interest Expense',
        'zh-CN': '其他非利息支出',
        'zh-TW': '其他非利息支出',
        'ja': 'その他の非利息費用',
    },
    ...
    'otherunder_preferred_stock_dividend': {
        'en': 'Other Under Preferred Stock Div',
        'zh-CN': '优先股股息下方其他项目',
        'zh-TW': '優先股股息下方其他項目',
        'ja': '優先配当金控除後のその他項目',
    },
    'paymentson_behalfof_employees': {
        'en': 'Payments on Behalf of Employees',
        'zh-CN': '代员工支付款项',
        'zh-TW': '代員工支付款項',
        'ja': '従業員代行支払',
    },
    'paymentsto_suppliersfor_goodsand_services': {
        'en': 'Payments to Suppliers',
        'zh-CN': '向供应商支付的商品及服务款项',
        'zh-TW': '向供應商支付的商品及服務款項',
        'ja': '商品及びサービスの仕入先への支払',
    },
    'pension_and_employee_benefit_expense': {
        'en': 'Pension And Employee Benefit Exp',
        'zh-CN': '养老金及员工福利支出',
        'zh-TW': '養老金及員工福利支出',
        'ja': '年金および従業員給付費用',
    },
    'pensionand_other_post_retirement_benefit_plans_current': {
        'en': 'Pension and Other Plans Current',
        'zh-CN': '流动养老及离职后福利',
        'zh-TW': '流動養老及離職後福利',
        'ja': '流動年金及び退職後給付制度',
    },
    'preferred_securities_outside_stock_equity': {
        'en': 'Pref Securities Outside Equity',
        'zh-CN': '普通权益外的优先证券',
        'zh-TW': '普通權益外的優先證券',
        'ja': '株主資本外の優先証券',
    },
    'preferred_shares_number': {
        'en': 'Preferred Shares Number',
        'zh-CN': '优先股数量',
        'zh-TW': '優先股數量',
        'ja': '優先株式数',
    },
    ...
    'preferred_stock_dividends': {
        'en': 'Preferred Stock Dividends',
        'zh-CN': '优先股股息',
        'zh-TW': '優先股股息',
        'ja': '優先株配当金',
    },
    'preferred_stock_equity': {
        'en': 'Preferred Stock Equity',
        'zh-CN': '优先股权益',
        'zh-TW': '優先股權益',
        'ja': '優先株主持分',
    },
    'preferred_stock_issuance': {
        'en': 'Preferred Stock Issuance',
        'zh-CN': '发行优先股',
        'zh-TW': '發行優先股',
        'ja': '優先株発行',
    },
    'preferred_stock_payments': {
        'en': 'Preferred Stock Payments',
        'zh-CN': '优先股支付额',
        'zh-TW': '優先股支付額',
        'ja': '優先株支払額',
    },
    ...
    'proceeds_from_stock_option_exercised': {
        'en': 'Proceeds From Stock Option',
        'zh-CN': '股票期权行权收入',
        'zh-TW': '股票期權行權收入',
        'ja': 'ストックオプション行使による収入',
    },
    'professional_expense_and_contract_services_expense': {
        'en': 'Professional and Contract Services',
        'zh-CN': '专业服务及合同支出',
        'zh-TW': '專業服務及合同支出',
        'ja': '専門および契約サービス費用',
    },
    'provisionand_write_offof_assets': {
        'en': 'Provision and Write Off of Assets',
        'zh-CN': '资产减值准备与核销',
        'zh-TW': '資產減值準備與核銷',
        'ja': '資産引当金および償却',
    },
    'purchase_of_intangibles': {
        'en': 'Purchase Of Intangibles',
        'zh-CN': '购买无形资产',
        'zh-TW': '購買無形資產',
        'ja': '無形資産の購入',
    },
    'purchase_of_investment_properties': {
        'en': 'Purchase Of Investment Prop',
        'zh-CN': '购买投资性房地产',
        'zh-TW': '購買投資性房地產',
        'ja': '投資不動産の購入',
    },
    ...
    'receiptsfrom_customers': {
        'en': 'Receipts from Customers',
        'zh-CN': '来自客户的收入',
        'zh-TW': '來自客戶的收入',
        'ja': '顧客からの収入',
    },
    'receivables_adjustments_allowances': {
        'en': 'Receivables Adjustments Allowances',
        'zh-CN': '应收账款调整及准备金',
        'zh-TW': '應收帳款調整及準備金',
        'ja': '売掛金調整および引当金',
    },
    'rent_and_landing_fees': {
        'en': 'Rent And Landing Fees',
        'zh-CN': '租金及着陆费',
        'zh-TW': '租金及著陸費',
        'ja': '賃借料および着陸料',
    },
    'rent_expense_supplemental': {
        'en': 'Rent Expense Supplemental',
        'zh-CN': '补充租金支出',
        'zh-TW': '補充租金支出',
        'ja': '追加賃借料',
    },
    ...
    'sale_of_intangibles': {
        'en': 'Sale Of Intangibles',
        'zh-CN': '出售无形资产',
        'zh-TW': '出售無形資產',
        'ja': '無形資産売却',
    },
    'sale_of_investment_properties': {
        'en': 'Sale Of Investment Properties',
        'zh-CN': '出售投资性房地产',
        'zh-TW': '出售投資性房地產',
        'ja': '投資不動産売却',
    },
    ...
    'taxes_refund_paid': {
        'en': 'Taxes Refund Paid',
        'zh-CN': '支付与退回的税费',
        'zh-TW': '支付與退回的稅費',
        'ja': '支払および還付税金',
    },
    'taxes_refund_paid_direct': {
        'en': 'Taxes Refund Paid Direct',
        'zh-CN': '税费退回（直接法）',
        'zh-TW': '稅費退回（直接法）',
        'ja': '税金還付（直接法）',
    },
    'total_other_finance_cost': {
        'en': 'Total Other Finance Cost',
        'zh-CN': '其他财务总成本',
        'zh-TW': '其他財務總成本',
        'ja': 'その他財務費用合計',
    },
    'total_unusual_items': {
        'en': 'Total Unusual Items',
        'zh-CN': '非经常性项目合计',
        'zh-TW': '非經常性項目合計',
        'ja': '非経常項目合計',
    },
    'total_unusual_items_excluding_goodwill': {
        'en': 'Total Unusual Items Excl Goodwill',
        'zh-CN': '除商誉外非经常性项目合计',
        'zh-TW': '除商譽外非經常性項目合計',
        'ja': 'のれんを除く非経常項目合計',
    },
    ...
    'unrealized_gain_loss_on_investment_securities': {
        'en': 'Unrealized Gain Loss On Inv. Sec.',
        'zh-CN': '未实现投资证券损益',
        'zh-TW': '未實現投資證券損益',
        'ja': '未実現投資有価証券評価損益',
    },
